...
The current version of this generator can be found at https://github.com/fectin/CepheusCraftDesign , and *my work in implementing it* is subject to the MIT license there. 
The above notwithstanding, this script uses material from the Cepheus Engine System Reference Document, Copyright © 2016 Samardan Press; Author Jason "Flynn" Kemp.
Cepheus Engine and Samardan Press are the trademarks of Jason "Flynn" Kemp. This site and its author are not affiliated with Jason "Flynn" Kemp or Samardan Press™.
...
My work implementing this process is available under the MIT License or the OGL, but you need other licenses as well.

Basically, I'm fine with you using my stuff however you want, but my stuff is inextricably intertwined with Moon Toad, Cepheus, and Traveller, and you need the OGL or other special permission to use that.
